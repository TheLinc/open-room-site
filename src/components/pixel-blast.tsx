// Pixel Blast from React Bits (https://reactbits.dev/backgrounds/pixel-blast),
// MIT licensed, copied from the TS + Tailwind variant on 2026-09-09. A
// Three.js shader that draws a lattice of pixel squares with edge fade and
// pointer ripples. Only the accessibility attribute on the container was
// changed: the field is decoration, so it is hidden from assistive tech.
